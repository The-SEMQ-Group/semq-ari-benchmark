"""The probe sweep's arithmetic, its development split, and its bookkeeping.

These pin the parts that would silently change a conclusion: the split rule,
the byte accounting, and whether the declared condition roles survive into the
report intact.
"""
